...
import com.example.xuqi.qqdemo.adapter.SlideRecyclerViewAdapter;
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_DOWN:
                if (mMenuState == MENU_CLOSED) {
                    ...
                    //获得这个view的ViewHolder
                    SlideRecyclerViewAdapter.Holder holder = (SlideRecyclerViewAdapter.Holder) getChildViewHolder(view);
                    //获得这个view的position
                    ...
                    tvDelete.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ...
                            // mListener在使用该RecyclerView的activity或fragment里定义，主要是对数据集合list的操作
